...
@RestController
@io.swagger.v3.oas.annotations.tags.Tag(name = "레시피 API", description = "레시피 관련 API")
...
public class RecipeController {
    ...
    public ResponseEntity<String> updateRecipeContent(
            ...
            @AuthenticationPrincipal UserDetailsImpl userDetails){
        return recipeService.updateRecipeContent(recipeId, recipeRequestDTO, userDetails);
    }
    ...
    //_____________________레시피 좋아용와 즐겨찾기__________________
    ...
    // 레시피 태그 검색
    @GetMapping("/tags")
    public ResponseEntity<List<Tag>> searchRecipeTags(
    ...
    //_____________________레시피 단계_______________________
